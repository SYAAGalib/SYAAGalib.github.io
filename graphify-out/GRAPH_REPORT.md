# Graph Report - dotcv-main  (2026-09-15)

## Corpus Check
- 32 files · ~127,958 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 134 nodes · 186 edges · 14 communities (10 shown, 2 thin omitted)
...
Cohesion: 0.18
Nodes (7): resolveAsset(), DotcvConfig, dotcvConfigSchema, getTranslations(), SupportedLocale, TranslationKey, translations

### Community 1 - "pages/index.astro"
Cohesion: 0.17
Nodes (9): cvSchema, loadConfig(), loadData(), parseJson(), jsonLd, nameParts, resolvedTheme, skillKeywords (+1 more)
...
Cohesion: 0.18
Nodes (10): activityItemSchema, certificationsSchema, CVData, educationItemSchema, experienceSchema, languageItemSchema, profileSchema, projectItemSchema (+2 more)

### Community 5 - "registry.ts"
Cohesion: 0.24
Nodes (8): resolvedTheme, resolvedTheme, getTheme(), ResolvedTheme, resolveTheme(), ThemeDefinition, ThemeName, themes
...
## Knowledge Gaps
- **62 isolated node(s):** `name`, `type`, `version`, `node`, `dev` (+57 more)
